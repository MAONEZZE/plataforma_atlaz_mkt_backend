...
def _product(name: str = "Pro Plan", value: Decimal = Decimal("99.90")) -> Product:
    return Product(id=uuid4(), name=name, value=value, description=None, cover_photo=None, created_at=NOW)
...
async def test_update_product_happy_path() -> None:
    product = _product()
    updated = Product(id=product.id, name="New Name", value=Decimal("149.00"), description=None, cover_photo=None, created_at=NOW)
